...
layui.define(["jquery", "miniMenu", "element","miniPage", "miniTheme", "axios", "storage"], function (exports) {
    ...
    var miniAdmin = {
        ...
        render: function (options) {
            ...
            options.menuInfo = options.menuInfo || null;
            ...
            // 渲染主体框架(菜单、页面、主题)
            var doRender = function (menuList) {
            ...
            // 如果传入了本地菜单数据(menuInfo)，则直接渲染，无需请求后端菜单接口
            if (options.menuInfo && options.menuInfo.length) {
                doRender(options.menuInfo);
                return;
            }
